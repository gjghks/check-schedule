...
def update_database():
    ...
    try:
        ...
        # Extra columns in DF that are not in DB might cause error or be ignored depending on method.
        # pandas to_sql default is 'fail' if table exists. append is safe.
        # But we need to ensure columns match.
